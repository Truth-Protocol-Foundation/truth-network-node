...
impl<T: frame_system::Config> orml_tokens::WeightInfo for WeightInfo<T> {
    ...
    fn transfer() -> Weight {
        ...
        Weight::from_parts(62_241_000, 6186)
    ...
    fn transfer_all() -> Weight {
        ...
        //  Measured:  `1690`
        //  Estimated: `6186`
        // Minimum execution time: 63_222 nanoseconds.
        Weight::from_parts(64_802_000, 6186)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    /// Storage: `Tokens::Accounts` (r:2 w:2)
    ...
    fn transfer_keep_alive() -> Weight {
        ...
        //  Measured:  `1546`
        //  Estimated: `6186`
        // Minimum execution time: 49_231 nanoseconds.
        Weight::from_parts(50_941_000, 6186)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    /// Storage: `Tokens::Accounts` (r:2 w:2)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(123), added: 2598, mode:
    /// `MaxEncodedLen`) Storage: `System::Account` (r:2 w:1)
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`)
    fn force_transfer() -> Weight {
        ...
        Weight::from_parts(56_472_000, 6204)
    ...
    fn set_balance() -> Weight {
        ...
        //  Measured:  `1361`
        //  Estimated: `3597`
        // Minimum execution time: 41_031 nanoseconds.
        Weight::from_parts(42_401_000, 3597)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
}

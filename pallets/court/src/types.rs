...
pub struct CourtPoolItem<AccountId, Balance, BlockNumber> {
    ...
    /// The index of the inflation period in which the court participant increased the stake
    /// lastly. The court participant can increase the stake by joining the court with a higher
    /// stake.
